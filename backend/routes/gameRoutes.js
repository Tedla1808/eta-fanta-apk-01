// --- backend/routes/gameRoutes.js --- (FINAL, CORRECTED, AND CONSOLIDATED)
...
// THIS IS THE VERSION CONTROL BLOCK FOR FORCING APP UPDATES
const APP_VERSION_CONFIG = {
    latestVersion: '1.0.0', // When you want to force an update, change this to '1.0.1', then '1.0.2', etc.
    updateUrl: 'https://t.me/etafanta_user' // This directs users to your Telegram channel for the new APK
};
// =========================================================

// GET /api/game/version - Returns the latest app version info for the client
