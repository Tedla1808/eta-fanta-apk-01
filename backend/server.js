// --- server.js --- (FINAL, CORRECTED, AND CONSOLIDATED FOR WEB & MOBILE)
...
// ** THIS IS THE CRITICAL CORS AND SOCKET.IO FIX FOR WEB AND MOBILE **
const allowedOrigins = [
    'https://www.etafanta.com',
    'https://etafanta.com',
    'http://localhost' // <-- CRUCIAL: This allows your Android app to connect
];
...
// Corrected paths for serving static files from the parent 'www' directory
...
// --- (The rest of the file is the same as your working version) ---
